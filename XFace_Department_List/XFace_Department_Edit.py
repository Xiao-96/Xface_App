...
class Screen17(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        title_label = customtkinter.CTkLabel(self.menu_frame, text="Department Edit", font=("Arial", 24), text_color="black", fg_color="transparent")
        ...
        self.department_name_entry = customtkinter.CTkEntry(self.menu_frame, font=("Arial", 20),  width=int(self.main_app.width/600*400), height=int(self.main_app.height/500*35), validate="key", validatecommand=vcmd50) 
        ...
        # Save Button
        save_btn = customtkinter.CTkButton(self.menu_frame, text=Department_Registration_textdir[10], command=lambda: self.save_data(), text_color="black", font=("Arial Blod", 20), fg_color="white", width=int(self.main_app.width/600*80), corner_radius=10, border_width=0, hover_color="gray", cursor="hand2")
    ...
    #Remove keybord settings and screen transitons
    ...
    def save_data(self):
        if self.flag:
            ...
            XFace_Database_Function.update_department(department_name, start_time, end_time, rest_time, over_time, self.department_name_txt)
            ...
            success_label = customtkinter.CTkLabel(master=self.message_frame, text="Department updated successfully.", font=("Arial", 20), text_color="black")
