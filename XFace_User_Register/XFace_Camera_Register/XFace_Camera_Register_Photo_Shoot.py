...
class Screen10(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # Add "<" Button
        back_btn = customtkinter.CTkButton(master=self.step_frame, command=lambda: self.next_screen(7), width=int(self.main_app.width/600*30), height=int(self.main_app.height/500*30), text="<", text_color="black", font=("Arial", 30), fg_color="transparent", hover=False, cursor="hand2")
    ...
    def update(self):
        ...
        print("register  after:", self.after_id)
    ...
    def camera_shoot_click(self):
        ...
        if hasattr(self, 'video_process') and self.video_process:
            ...
            self.video_process = None 
        if ret:
            photo_shoot_confirm_path = self.main_app.photo_get("register")
            ...
            self.accept_button = customtkinter.CTkButton(master=self.step_frame, command=lambda: self.next_screen(9), text="OK", font=("Arial", 20), text_color="black", width=int(self.main_app.width/600*120), height=int(self.main_app.height/500*60), fg_color="#D9D9D9", bg_color="#ffffff", corner_radius=10, cursor="hand2")
