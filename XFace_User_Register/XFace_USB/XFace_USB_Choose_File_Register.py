...
class Screen12(tk.Frame):
    def __init__(self, parent, main_app):
        ...
        # Add "<" Button
        back_btn = customtkinter.CTkButton(self, command=lambda: self.next_screen(7), width=int(self.main_app.width/600*30), height=int(self.main_app.height/500*30), text="<", text_color="black", font=("Arial", 30), fg_color="transparent", bg_color="#e6e6e6", hover=False, cursor="hand2")
    ...
    # Copy selected images to "photoget_register.png"
    def open_image(self, img_path):
        ...
        self.main_app.show_next_screen(9)
